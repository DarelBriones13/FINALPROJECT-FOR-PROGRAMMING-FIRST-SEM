...
public class MakeReservation extends javax.swing.JFrame {
        ...
        if (!errorOccurred) {
            ...
            if (confirm == JOptionPane.YES_OPTION) {
                try {
                    ...
                    String relativePath = userHome + File.separator + "Downloads" + File.separator + "Briones_RegisterLogIn" + File.separator + "RESERVATION LIST INFORMATION" + File.separator + "ReservationList.txt";
    ...
    try {
        String userHome = System.getProperty("user.home");
        String filePath = userHome + File.separator + "Downloads" + File.separator + "Briones_RegisterLogIn" + File.separator + "RESERVATION LIST INFORMATION" + File.separator + "ReservationList.txt";
