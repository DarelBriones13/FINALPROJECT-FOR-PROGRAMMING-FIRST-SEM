...
public class LOGIN extends javax.swing.JFrame {
    ...
    private void btnLoginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnLoginActionPerformed
        ...
        String filePath = System.getProperty("user.home") + File.separator + "Downloads" + File.separator + "Briones_RegisterLogIn" + File.separator + "RESERVATION ACCOUNT INFORMATION" + File.separator + txtEmail_Num.getText() + ".txt";
