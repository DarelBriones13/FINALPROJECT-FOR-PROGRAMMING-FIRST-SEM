...
public class SignUp extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setTitle("SIGNUP");
        setPreferredSize(new java.awt.Dimension(815, 652));
        setResizable(false);
    ...
    private void btnSignUpActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSignUpActionPerformed
            ...
            if (!errorOccurred) {
                try {
                    ...
                    String filePath = userHome + File.separator + "Downloads" + File.separator + "Briones_RegisterLogIn" + File.separator + "RESERVATION ACCOUNT INFORMATION" + File.separator + email_num + ".txt";
    ...
    String userHome = System.getProperty("user.home");
    String directoryPath = userHome + File.separator + "Downloads" + File.separator + "Briones_RegisterLogIn" + File.separator + "RESERVATION ACCOUNT INFORMATION";
